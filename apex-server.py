...
<div class="err">❌ {html.escape(r["error"])}</div></div>""")
        ...
        msg = (f"Here's your {brand} setup 🚀\n\n"
               f"1) App for your device (recommended — all work perfectly with this link):\n"
               f"   📱 iPhone/iPad → Shadowrocket (or Fugu)\n"
               f"   🤖 Android → v2rayNG (or NekoBox / Hiddify)\n"
               f"   💻 Windows → v2rayN (or Hiddify / Clash Verge)\n"
               f"   🍎 Mac → Hiddify (or Clash Verge)\n\n"
               f"2) Add this ONE link in your app (it auto-detects your app and arrives named \"{brand}\"):\n{allink}\n\n"
               f"3) Check your data anytime (live):\n{full}\n\n"
               f"⚠️ If your app shows \"unsupported proxy type\" — the app is too old for VLESS nodes. "
               f"Update it, or install one of the apps in step 1 (the link works perfectly there).\n\n"
...
<div class="note">📱 The one link arrives in Shadowrocket already named <b>{html.escape(brand)}</b> — clients add it, nothing to rename. The .txt is the offline backup (paste into Shadowrocket → same name).<br><br>
<b>Works on:</b> 📱 iOS — Shadowrocket / Fugu / FoXray · 🤖 Android — v2rayNG / NekoBox / Hiddify · 💻 Windows — v2rayN / Hiddify / Clash Verge · 🍎 Mac — Hiddify / Clash Verge<br>
<span style="color:#fbbf24">"Unsupported proxy type" in an app = that app is too old for VLESS (any plan) — client should update it or use a listed app.</span></div></div>""")
